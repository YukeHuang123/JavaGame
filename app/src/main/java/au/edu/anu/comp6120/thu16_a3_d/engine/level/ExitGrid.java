...
public class ExitGrid implements Grid{
     ...
     *
     * @return true, indicating that the exit grid is solid and cannot be passed through.
     */
    @Override
     ...
     * This method is currently empty, as there is no data to deserialize for the exit grid.
     *
