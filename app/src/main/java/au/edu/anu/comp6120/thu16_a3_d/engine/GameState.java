...
/**
 * Represents the state of the game, including the player, NPCs, items, and the game map.
 * Implements the {@link ISerializable} and {@link IDisplayable} interfaces for serialization
...
public class GameState implements ISerializable, IDisplayable {
    ...
    /**
     * Fetches the bonus item found at the player's current location and adds it to the inventory.
    ...
    /**
     * Initiates the fight with the NPC, setting the pre-fight health for both the player and the NPC.
     */
     ...
     * @param weaponIndex The index of the weapon in the inventory used for the fight.
     */
    ...
    /**
     * Deserializes the game state from the given JSON data and updates the current state.
    ...
    /**
     * Returns a string representation of the game state, including life, map, entities, items, and inventory.
