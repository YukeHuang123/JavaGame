...
public class Entity implements ISerializable {
    ...
    /**
     * Constructs a new Entity with the specified maximum health, attack, location, and type.
    ...
    /**
     * Returns a string representation of the entity, including its type, health, and attack.
