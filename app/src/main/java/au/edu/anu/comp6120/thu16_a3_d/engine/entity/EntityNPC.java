...
public class EntityNPC extends Entity implements IDisplayable {
    ...
    /**
     * Constructs a new EntityNPC with the specified maximum health, attack, and location.
    ...
    /**
     * Returns a string representation of the NPC, including its health and attack details.
    ...
    /**
     * Displays the NPC's details, including its health and attack power, in a formatted way.
     */
    @Override
    public void display() {
