...
import au.edu.anu.comp6120.thu16_a3_d.engine.level.EntityGrid;
import au.edu.anu.comp6120.thu16_a3_d.engine.level.ExitGrid;
import au.edu.anu.comp6120.thu16_a3_d.engine.level.GameMap;
import au.edu.anu.comp6120.thu16_a3_d.engine.level.ItemGrid;
...
public class GameStateTest {
     ...
     * Initializes the GameState instance and spawns the player at the origin (0, 0).
     */
    @BeforeEach
    public void setUp() {
     ...
     * Attempts to move the player out of bounds and verifies that the player's location remains unchanged.
     */
    @Test
     ...
     * Moves the player to an exit grid and verifies that the game status is set to WIN.
     */
    @Test
    public void testWin() {
     ...
     * Sets up a scenario where the player encounters an NPC that they cannot defeat, resulting in a loss.
     */
    @Test
     ...
     * Moves the player to locations containing bonus items and verifies the game status changes accordingly.
     */
    @Test
