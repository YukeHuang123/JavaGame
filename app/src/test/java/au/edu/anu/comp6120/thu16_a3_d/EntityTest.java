...
public class EntityTest {
     ...
     * Ensures that the attributes (health, attack, type, location) are correctly set during initialization.
     */
    @Test
     ...
     * Ensures that health is correctly restored after healing, but not beyond the max health.
     */
    @Test
    void testEntityHeal() {
     ...
     * Ensures that the entity's health does not go below zero and that it is marked as dead when health reaches 0.
     */
    @Test
     ...
     * Ensures that the entity is serialized into a valid JSON string with correct attribute values.
     */
    @Test
    void testSerialization() {
        ...
        Assertions.assertTrue(serializedData.contains("\"type\": \"player\""), "Serialized data should contain entity type");
        ...
        Assertions.assertTrue(serializedData.contains("\"type\": \"enemy\""), "Serialized data should contain entity type");
     ...
     * Ensures that the entity is deserialized from a JSON string and that the attributes match the deserialized values.
     */
    @Test
